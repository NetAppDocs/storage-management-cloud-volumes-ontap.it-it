...
. Nella pagina *Sistemi*, fare clic su *Aggiungi sistema* e seguire i passaggi nella console NetApp .
+
...
. https://docs.netapp.com/us-en/bluexp-setup-admin/task-adding-nss-accounts.html#add-an-nss-account["Aggiungi il tuo account del sito di supporto NetApp alla console NetApp"^]
+
