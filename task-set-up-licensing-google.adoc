...
. https://docs.netapp.com/us-en/console-setup-admin/task-adding-nss-accounts.html#add-an-nss-account["Aggiungi il tuo account del sito di supporto NetApp alla NetApp Console"^]
+
...
TIP: Puoi gestire gli abbonamenti a Google Cloud Marketplace associati ai tuoi account dalla pagina Impostazioni > Credenziali. https://docs.netapp.com/us-en/console-setup-admin/task-adding-gcp-accounts.html["Scopri come gestire le tue credenziali e i tuoi abbonamenti Google Cloud"^]
