...
https://docs.netapp.com/us-en/console-setup-admin/task-configuring-proxy.html#enable-a-proxy-on-a-connector["Scopri come abilitare il traffico API diretto sull'agente Console"^]
