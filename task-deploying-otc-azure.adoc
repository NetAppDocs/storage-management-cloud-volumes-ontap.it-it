...
+
Questa opzione è disponibile solo per alcuni tipi di VM. Per scoprire quali tipi di VM sono supportati, consulta link:link:reference-configs-azure.html#ha-pairs["Configurazioni supportate per licenza per coppie HA"].
...
+
link:link:reference-configs-azure.html#ha-pairs["Scopri di più sulle configurazioni supportate in Azure"^].
