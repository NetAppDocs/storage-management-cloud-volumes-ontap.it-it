...
+
link:https://docs.netapp.com/us-en/data-services-backup-recovery/concept-backup-to-cloud.html["Scopri di più su Backup e Ripristino"^]
...
+
https://docs.netapp.com/us-en/data-services-data-classification/concept-cloud-compliance.html["Scopri di più sulla classificazione dei dati"^]
...
link:https://www.netapp.com/ontap-cloud/["Scopri di più su Cloud Volumes ONTAP"^]
