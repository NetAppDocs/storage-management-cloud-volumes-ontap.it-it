...
* Lo strumento di conversione delle licenze supporta tutti i tipi di deployment, come nodo singolo, high availability (HA) in single availability zone (AZ), HA in multiple AZ, Bring-Your-Own License (BYOL) e PAYGO.
...
Se hai una distribuzione in modalità privata, puoi convertire la tua licenza basata sui nodi in una licenza basata sulla capacità usando lo strumento di conversione delle licenze nella NetApp Console. La conversione è supportata per tutti i provider cloud, AWS, Azure e Google Cloud.

Poiché gli abbonamenti al marketplace non sono supportati in modalità privata, devi acquistare un pacchetto Essentials Bring-Your-Own License o BYOL da NetApp. Questo ti permette di mantenere i vantaggi della licenza basata sulla capacità all'interno del modello BYOL senza richiedere abbonamenti al marketplace.
