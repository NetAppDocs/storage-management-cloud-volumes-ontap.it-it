...
Queste autorizzazioni sono incluse in https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-aws.html["le policy fornite da NetApp"^]
...
+
https://docs.netapp.com/us-en/data-services-replication/task-replicating-data.html["Scopri come impostare la replica dei dati"^]
