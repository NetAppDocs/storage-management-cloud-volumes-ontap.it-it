...
Cloud Volumes ONTAP deve essere registrato presso il Supporto NetApp per poter aggiornare il software utilizzando uno qualsiasi dei metodi descritti in questa pagina. Questo vale sia per pay-as-you-go (PAYGO) che per Bring-Your-Own License (BYOL). Dovrai link:task-registering.html["registrare manualmente i sistemi PAYGO"], mentre i sistemi BYOL sono registrati per impostazione predefinita.
...
. Sulla casella dell'aggregato richiesto, fai clic sull'icona image:icon-action.png["Un'icona che mostra tre puntini orizzontali per azioni aggiuntive"] e poi seleziona *Visualizza dettagli aggregato*.
+
...
. Sul sistema, fai clic sull'icona image:icon-action.png["Un'icona che mostra tre puntini orizzontali per azioni aggiuntive"] e poi su *Aggiorna Cloud Volumes ONTAP*.
