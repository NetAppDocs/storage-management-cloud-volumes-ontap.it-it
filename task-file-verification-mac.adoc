...
+
Consulta  https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-azure-download-digest-file.html["Scarica il file digest dell'immagine di Azure"^] per maggiori informazioni.
