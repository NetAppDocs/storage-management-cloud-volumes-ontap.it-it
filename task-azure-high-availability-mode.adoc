...
.Passi
Un utente Azure con privilegi di _Owner_ può abilitare la funzionalità dall'Azure CLI.
...
.Link correlati
. https://learn.microsoft.com/en-us/azure/load-balancer/load-balancer-ha-ports-overview["Microsoft Azure documentation: panoramica delle porte ad alta disponibilità"^]
. https://learn.microsoft.com/en-us/cli/azure/get-started-with-azure-cli?view=azure-cli-latest["Microsoft Azure documentazione: Introduzione all'Azure CLI"^]
