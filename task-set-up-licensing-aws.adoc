...
. Quando si implementa un nuovo sistema Cloud Volumes ONTAP, selezionare il pacchetto Essentials per la fatturazione tramite l'abbonamento autonomo. Per informazioni, consultare  https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-quick-deploy-aws.html["Distribuisci Cloud Volumes ONTAP con creazione rapida"^].
