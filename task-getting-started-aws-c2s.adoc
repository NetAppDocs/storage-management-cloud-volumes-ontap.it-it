...
summary: Puoi distribuire Cloud Volumes ONTAP negli ambienti AWS Secret Cloud e Top Secret Cloud. Le regioni AWS Secret Cloud e Top Secret Cloud sono regioni chiuse specifiche per la U.S. Intelligence Community. Le istruzioni in questa pagina si applicano solo agli utenti delle regioni AWS Secret Cloud e Top Secret Cloud. 
---
...
+
Per ulteriori informazioni su come funziona la modalità privata, consultare link:https://docs.netapp.com/us-en/console-setup-admin/concept-modes.html#private-mode["la modalità di distribuzione privata nella Console"^].
