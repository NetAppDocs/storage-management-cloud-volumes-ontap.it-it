...
----
+
L'URL segue un formato standard. Per l'automazione, puoi ricavare la stringa URL come mostrato di seguito. In alternativa, puoi utilizzare il comando Azure CLI `az` per ottenere l'URL. Esempio di URL: +https://examplesaname.bluexpinfraprod.eastus2.data.azurecr.io/vm-images/9150.01000024.05090105.vhd+
