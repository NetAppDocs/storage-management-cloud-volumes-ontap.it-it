...
| Modifica progetto  a| 
Seleziona il progetto in cui desideri che risieda Cloud Volumes ONTAP.
...
. *Modelli di deployment HA*: scegli più zone (consigliato) o una singola zona per la configurazione HA. Quindi seleziona una regione e una zona.
+
