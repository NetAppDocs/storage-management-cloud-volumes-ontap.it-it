...
* L'abbonamento è registrato per la funzionalità Microsoft `Microsoft.Compute/VMOrchestratorZonalMultiFD`. https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-saz-feature.html["Scopri come abilitare VMOrchestratorZonalMultiFD per zone di disponibilità singole"^].
...
* https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/concept-ha-azure.html["Scopri le coppie ad alta disponibilità in Azure"^].
