...
---
= Scopri Cloud Volumes ONTAP node-based BYOL
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
link:concept-licensing.html["Scopri di più sulle licenze Cloud Volumes ONTAP"].

link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-node-licenses.html["Scopri di più su come gestire le licenze basate sui nodi"^].
...
https://docs.netapp.com/us-en/console-setup-admin/task-adding-nss-accounts.html["Scopri come aggiungere account del sito di supporto NetApp alla console"^].
