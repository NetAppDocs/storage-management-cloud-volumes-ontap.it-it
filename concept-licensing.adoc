...
Hai la possibilità di acquistare o rinnovare le tue licenze e subscriptions dai cloud marketplace o tramite NetApp (bring your own license (BYOL)). Il marketplace offre abbonamenti annuali e opzioni pay-as-you-go (PAYGO). Per informazioni, vedi link:concept-license-management.html["Scopri di più sulle licenze basate sulla capacità per Cloud Volumes ONTAP"].
