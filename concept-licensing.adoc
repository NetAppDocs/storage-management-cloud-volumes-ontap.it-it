...
* link:link:reference-configs-azure.html["Configurazioni supportate in Azure"]
...
* link:link:reference-configs-gcp.html["Configurazioni supportate in Google Cloud"^]
