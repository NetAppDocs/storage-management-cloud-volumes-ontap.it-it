...
* Per Cloud Volumes ONTAP è disponibile una licenza gratuita fino a 500 GiB di capacità allocata, senza NetApp supporto e senza data di scadenza. Per capacità superiori a 500 GiB è necessaria una licenza valida e potrebbero essere applicati dei costi. Per accedere all'esperienza completa di Cloud Volumes ONTAP e alle funzionalità di gestione avanzate, collega il tuo sistema Cloud Volumes ONTAP alla NetApp Console. Il rilevamento e la gestione tramite NetApp Console richiedono un abbonamento valido ad Azure Marketplace associato al tuo account NetApp Console.
...
.Prima di iniziare
* Se hai intenzione di individuare e gestire il sistema distribuito in NetApp Console, assicurati che l'account NetApp Console sia associato a un abbonamento valido di Azure Marketplace. L'individuazione del sistema in NetApp Console richiede un abbonamento valido.
