...
.Passi
. Seleziona la vista System Manager per ridimensionare un volume tramite ONTAP System Manager. Fai riferimento a link:task-administer-advanced-view.html#get-started-with-system-manager["Inizia con System Manager"].
...
TIP: La console visualizza questi messaggi "Azione richiesta" quando un aggregato raggiunge il 90% della capacità utilizzata. Se il data tiering è abilitato, i messaggi vengono visualizzati quando un aggregato raggiunge l'80% della capacità utilizzata. Per impostazione predefinita, il 10% di spazio libero è riservato al data tiering. link:task-tiering.html#change-the-free-space-ratio-for-data-tiering["Scopri di più sul rapporto di spazio libero per la suddivisione in livelli dei dati"^].
...
.. Nella sezione relativa ai dati aggregati, fai clic sull'icona image:icon-action.png["Un'icona che mostra tre puntini orizzontali per azioni aggiuntive"] e poi su *Visualizza dettagli aggregati*.
...
+
Per ulteriori informazioni, fai riferimento a link:https://docs.netapp.com/us-en/data-services-replication/task-replicating-data.html["Replica dei dati tra i sistemi"^].
...
+
Per ulteriori informazioni, fai riferimento a link:https://docs.netapp.com/us-en/data-services-replication/task-replicating-data.html#managing-data-replication-schedules-and-relationships["Gestione delle pianificazioni e delle relazioni di replicazione dei dati"^].
...
+
.. Nel sistema Cloud Volumes ONTAP , fare clic sulla scheda *Aggregati*.
.. Sulla tessera dell'aggregato richiesto, fai clic sull'icona image:icon-action.png["Un'icona che mostra tre puntini orizzontali per azioni aggiuntive"] e poi su *Visualizza dettagli aggregato* per vedere la capacità disponibile (dimensione prevista meno capacità aggregata utilizzata).
+
...
+
.. Seleziona l'aggregato, quindi fai clic sull'icona image:icon-action.png["Un'icona che mostra tre puntini orizzontali per azioni aggiuntive"] > *Aggiungi dischi*.
