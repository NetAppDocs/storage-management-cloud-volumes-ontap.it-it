...
+
Salta la selezione delle impostazioni di efficienza di archiviazione quando crei un volume dalla console NetApp oppure crea un volume e poi http://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-vsmg/GUID-8508A4CB-DB43-4D0D-97EB-859F58B29054.html["disabilitare la compressione dei dati utilizzando la CLI"^] .
