...
| Gamma completa di tipologie di macchine virtuali. link:reference-configs-azure.html["Configurazioni supportate in Azure"] 
...
| *Tipo di disco supportato* | Dischi gestiti Premium SSD v2 | Maggiore supporto. link:reference-configs-azure.html#azure-storage-for-user-data["Tipi di disco supportati in Azure"] 
...
* link:https://docs.netapp.com/us-en/console-family/index.html["Documentazione NetApp Console"^]
