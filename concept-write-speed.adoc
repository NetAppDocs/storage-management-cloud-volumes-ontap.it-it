...
---
= Scopri la velocità di scrittura su Cloud Volumes ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
link:reference-configs-aws.html["Scopri di più sulle istanze Amazon EC2 supportate da Cloud Volumes ONTAP"].
...
Se si utilizza un sistema a nodo singolo, Cloud Volumes ONTAP supporta un'elevata velocità di scrittura con tutti i tipi di istanze di macchine virtuali.

Se usi una coppia HA, Cloud Volumes ONTAP supporta alta velocità di scrittura con diversi tipi di VM, a partire dalla versione 9.8. Vai alla link:reference-configs-azure.html["Note sulla versione Cloud Volumes ONTAP"] per vedere i tipi di VM che supportano alta velocità di scrittura.
...
Se usi una coppia HA, Cloud Volumes ONTAP supporta alta velocità di scrittura con diversi tipi di VM, a partire dalla release 9.13.0. Vai alla link:reference-configs-gcp.html#supported-configurations-by-license["Note sulla versione Cloud Volumes ONTAP"^] per vedere i tipi di VM che supportano alta velocità di scrittura.

link:reference-configs-gcp.html["Scopri di più sui tipi di macchine Google Cloud supportati da Cloud Volumes ONTAP"^].
