...
--
Dimensione del disco GCP:: Quando si distribuisce un sistema Cloud Volumes ONTAP , è necessario scegliere una dimensione iniziale del disco.  Dopodiché puoi lasciare che la console NetApp gestisca la capacità di un sistema per te, ma se vuoi creare aggregati autonomamente, tieni presente quanto segue:
+
--
