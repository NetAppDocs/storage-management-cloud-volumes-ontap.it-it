...
Se non hai un https://docs.netapp.com/us-en/bluexp-setup-admin/concept-connectors.html["Agente console"^] eppure devi crearne uno. https://docs.netapp.com/us-en/console-setup-admin/task-install-agent-google-gcloud.html["Scopri come creare un agente Console in Google Cloud"^]
...
[role="quick-margin-para"]
https://cloud.google.com/apis/docs/getting-started#enabling_apis["Abilita le API di Google Cloud nel tuo progetto"^]. https://docs.netapp.com/us-en/console-setup-admin/task-install-agent-google-gcloud.html#step-5-enable-google-cloud-apis["Queste API"^], che potresti aver già abilitato durante la creazione dell'agente Console, sono necessari per distribuire Cloud Volumes ONTAP in Google Cloud.
