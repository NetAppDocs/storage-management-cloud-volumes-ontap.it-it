...
* Quando crei un volume iSCSI, la Console crea automaticamente un LUN per te. Abbiamo semplificato il processo creando un solo LUN per volume, così non c'è gestione da fare. Dopo aver creato il volume, link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-connect-lun.html["utilizzare l'IQN per connettersi al LUN dai tuoi host"^].
* È possibile creare LUN aggiuntivi da ONTAP System Manager o da ONTAP CLI.


ifdef::aws[]

* Se vuoi utilizzare CIFS in AWS, devi aver configurato DNS e Active Directory. Per dettagli, consulta link:reference-networking-aws.html["Requisiti di rete per Cloud Volumes ONTAP in AWS"].
...
.Aggregato specifico
--
.. Nella scheda *Aggregati*, vai all'aggregato desiderato e fai clic sull'icona image:icon-action.png["Un'icona che mostra tre puntini orizzontali per azioni aggiuntive"].
...
+
*** link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config.html#size-your-system-in-aws["Dimensionamento del sistema in AWS"^]
...
* link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config-azure.html#size-your-system-in-azure["Dimensionamento del sistema in Azure"^]
...
* link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config-gcp.html#size-your-system-in-gcp["Dimensionamento del sistema in Google Cloud"^]
