...
=== Configurazione di Infrastructure Manager per distribuzioni in modalità privata

Se si desidera distribuire Cloud Volumes ONTAP 9.16.1 o versioni successive in modalità privata, è necessario apportare alcune modifiche alla configurazione in modo che Cloud Volumes ONTAP possa utilizzare Google Cloud Infrastructure Manager come servizio di distribuzione invece di Deployment Manager, che Google alla fine disattiverà.
