...
* Se non hai ancora registrato un account NSS nella Console, registralo ora e poi viene visualizzata l'interfaccia utente di Digital Advisor. Consulta  https://docs.netapp.com/us-en/console-setup-admin/task-adding-nss-accounts.html["Gestire le credenziali NSS associate a un'organizzazione o a un account"] per le istruzioni.
