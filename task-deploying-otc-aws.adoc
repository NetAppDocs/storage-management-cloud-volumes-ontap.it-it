...
---
= Distribuisci Cloud Volumes ONTAP utilizzando le opzioni avanzate in AWS
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
+
** Dovresti avere un  https://docs.netapp.com/us-en/console-setup-admin/task-quick-start-connector-aws.html["Agente console associato al tuo sistema"^].
...
. Se ti viene richiesto, https://docs.netapp.com/us-en/console-setup-admin/task-quick-start-connector-aws.html["creare un agente Console"^].
...
| Modifica credenziali | Scegli le credenziali AWS associate all'account in cui vuoi distribuire questo sistema. Puoi anche associare l'abbonamento al marketplace AWS da usare con questo sistema Cloud Volumes ONTAP. Fai clic su *Aggiungi abbonamento* per associare le credenziali selezionate a un nuovo abbonamento al marketplace AWS. L'abbonamento può essere per un contratto annuale oppure per pagare Cloud Volumes ONTAP a tariffa oraria. https://docs.netapp.com/us-en/console-setup-admin/task-adding-aws-accounts.html["Scopri come aggiungere ulteriori credenziali AWS alla NetApp Console"^]. 
|===
+
...
. *Posizione e connettività*: Inserisci le informazioni di rete che hai registrato in  https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config.html#collect-networking-information["Foglio di lavoro AWS"^].
+
...
| Modifica credenziali | Scegli le credenziali AWS e l'abbonamento al marketplace da usare con questo sistema Cloud Volumes ONTAP. Fai clic su *Aggiungi abbonamento* per associare le credenziali selezionate a un nuovo abbonamento al marketplace AWS. L'abbonamento può essere per un contratto annuale o per pagare Cloud Volumes ONTAP a una tariffa oraria. Se hai acquistato una licenza direttamente da NetApp (Bring-Your-Own License o BYOL), allora non è richiesto un abbonamento AWS. NetApp ha limitato l'acquisto, l'estensione e il rinnovo delle licenze BYOL. Per ulteriori informazioni, consulta  https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/whats-new.html#restricted-availability-of-byol-licensing-for-cloud-volumes-ontap["Disponibilità limitata delle licenze BYOL per Cloud Volumes ONTAP"^]. https://docs.netapp.com/us-en/console-setup-admin/task-adding-aws-accounts.html["Scopri come aggiungere ulteriori credenziali AWS alla Console"^]. 
|===
+
...
+
** https://docs.netapp.com/us-en/data-services-data-classification/concept-cloud-compliance.html["Scopri di più sulla NetApp Data Classification"^]
** https://docs.netapp.com/us-en/data-services-backup-recovery/task-backup-to-s3.html["Scopri di più su Backup e Ripristino"^]
+
...
.Link correlati
* link:task-onboard-cvo-aws-marketplace.html["Iscriviti e distribuisci Cloud Volumes ONTAP da AWS Marketplace"]
