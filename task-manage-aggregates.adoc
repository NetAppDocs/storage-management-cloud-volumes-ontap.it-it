...
CAUTION: Tutti i dischi e gli aggregati devono essere creati ed eliminati direttamente dalla console NetApp . Non dovresti eseguire queste azioni da un altro strumento di gestione. Ciò potrebbe compromettere la stabilità del sistema, ostacolare la possibilità di aggiungere dischi in futuro e potenzialmente generare commissioni ridondanti per il provider cloud.
