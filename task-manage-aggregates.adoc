...
. Per l'aggregato richiesto, fai clic sull'icona image:icon-action.png["Un'icona che mostra tre puntini orizzontali per azioni aggiuntive"] per le azioni di gestione.
+
image:screenshot_aggr_menu_options.png["Uno screenshot delle opzioni del menu Aggregati."]

. Gestisci i tuoi aggregati dalle opzioni disponibili nel image:icon-action.png["Un'icona che mostra tre puntini orizzontali per azioni aggiuntive"] menu.
...
. Nel menu image:icon-action.png["Un'icona che mostra tre puntini orizzontali per azioni aggiuntive"], fai clic su *Aumenta capacità*.
