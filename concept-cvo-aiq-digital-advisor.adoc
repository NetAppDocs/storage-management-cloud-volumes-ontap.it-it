...
[role="lead"]
https://www.netapp.com/data-services/digital-advisor/["NetApp Active IQ Digital Advisor"^] (noto anche come Digital Advisor) è integrato nella NetApp Console così puoi ottimizzare le operazioni, la sicurezza e le prestazioni dei tuoi sistemi Cloud Volumes ONTAP da un'unica interfaccia.
