...
summary: Gestisci le tue licenze basate sulla capacità dalla console NetApp per assicurarti che il tuo account NetApp disponga di capacità sufficiente per i tuoi sistemi Cloud Volumes ONTAP . 
---
