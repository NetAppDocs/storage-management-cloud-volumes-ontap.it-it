...
[role="lead"]
Cloud Volumes ONTAP richiede un account di servizio Google Cloud per due motivi. Il primo è quando abiliti link:concept-data-tiering.html["livelli di dati"] il tiering dei dati a freddo verso lo storage a oggetti a basso costo in Google Cloud. Il secondo è quando abiliti il  https://docs.netapp.com/us-en/data-services-backup-recovery/concept-backup-to-cloud.html["NetApp Backup and Recovery"^] backup dei volumi verso lo storage a oggetti a basso costo.
