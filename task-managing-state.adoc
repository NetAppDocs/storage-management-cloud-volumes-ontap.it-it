...
summary: È possibile arrestare e avviare Cloud Volumes ONTAP dalla console NetApp per gestire i costi di elaborazione cloud. 
---
...
[role="lead"]
È possibile arrestare e avviare Cloud Volumes ONTAP dalla console NetApp per gestire i costi di elaborazione cloud.
