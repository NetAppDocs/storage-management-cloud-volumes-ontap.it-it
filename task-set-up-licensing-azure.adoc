...
Seleziona l'offerta Freemium per usare Cloud Volumes ONTAP gratis con una capacità di provisioning fino a 500 GiB. link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html#packages["Scopri di più sull'offerta Freemium"^].
...
+
La licenza deve essere disponibile dalla Console prima di poterla utilizzare con Cloud Volumes ONTAP. Se necessario, puoi link:task-manage-capacity-licenses.html#how-licenses-are-added-to-netapp-console["aggiungere manualmente la licenza alla Console"].
...
TIP: Puoi gestire gli abbonamenti ad Azure Marketplace associati ai tuoi account Azure dalla pagina Impostazioni > Credenziali. https://docs.netapp.com/us-en/console-setup-admin/task-adding-azure-accounts.html["Scopri come gestire i tuoi account e abbonamenti Azure"^]
