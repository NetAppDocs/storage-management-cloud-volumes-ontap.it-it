...
.Passi
. Rimuovi il sistema Cloud Volumes ONTAP. Fai riferimento a link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-removing.html["Rimozione dei sistemi Cloud Volumes ONTAP"].
