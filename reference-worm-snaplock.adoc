...
.Link correlati
* Per ulteriori informazioni su WORM, fare riferimento alink:concept-worm.html["Scopri di più sullo storage WORM su Cloud Volumes ONTAP"] .
* Per informazioni sulla ricarica dei volumi SnapLock , fare riferimento alink:concept-licensing-charging.html["Licenze e addebiti in Cloud Volumes ONTAP"] .
