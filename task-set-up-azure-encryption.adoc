...
----
https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html["Visualizza l'elenco più recente delle autorizzazioni"^]

.Passi
. Ottieni l'elenco degli insiemi di chiavi nella tua sottoscrizione di Azure utilizzando le seguenti chiamate API.
+
https://docs.netapp.com/us-en/console-automation/cvo/get-azure-ha-metadata-keys-vault.html["Per una coppia HA"^]: `GET /azure/ha/metadata/vaults`

+
https://docs.netapp.com/us-en/console-automation/cvo/get-azure-vsa-metadata-keys-vault.html["Per singolo nodo"^]: `GET /azure/vsa/metadata/vaults`
...
+
Per una coppia HA: `GET /azure/ha/metadata/keys-vault?resourceGroupName=KeyVaultResourceGroup&vaultName=KeyVault`

+
Per nodo singolo: `GET /azure/vsa/metadata/keys-vault?resourceGroupName=KeyVaultResourceGroup&vaultName=KeyVault`
...
+
.. Per una coppia HA utilizzare  https://docs.netapp.com/us-en/console-automation/cvo/post-azure-ha-working-environments.html["questa chiamata API"^]:
+
...
.. Per un sistema a nodo singolo utilizzare  https://docs.netapp.com/us-en/console-automation/cvo/post-azure-vsa-working-environments.html["questa chiamata API"^]:
+
...
.Link correlati
* https://docs.netapp.com/us-en/console-automation/cm/wf_cvo_before.html["Preparati a utilizzare i workflow delle API di Cloud Volumes ONTAP"^].
* https://docs.netapp.com/us-en/console-automation/cm/api_ref_resources.html#azure-haworking-environments["Scopri le ONTAP management REST API"^].
