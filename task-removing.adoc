...
. In alto a destra della Console, fai clic sull'icona image:icon-action.png["Un'icona che mostra tre puntini orizzontali per azioni aggiuntive"] e seleziona *Rimuovi dall'area di lavoro*.
