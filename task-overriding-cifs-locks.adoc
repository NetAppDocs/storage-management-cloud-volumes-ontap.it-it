...
.Prima di iniziare
Devi creare un agente Console prima di poter modificare le impostazioni della Console https://docs.netapp.com/us-en/console-setup-admin/concept-connectors.html#how-to-create-a-connector["Scopri come"^].
